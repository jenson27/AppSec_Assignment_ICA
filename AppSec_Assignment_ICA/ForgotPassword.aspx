<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="AppSec_Assignment_ICA.ForgotPassword" %>
...
<body>
    ...
    <h2>
        ...
        <table class="style1">
            <tr>
                <td class="style3">
                    <asp:Label ID="Email" runat="server" Text="Emaill Adress:"></asp:Label>
                </td>
                <td class="style2">
